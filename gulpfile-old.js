...
//Directory Addresses, defined as SCSS Globs
//Globs are string of literal and/or wildcard characters used to match filepaths.
const SCSS_SRC = "./src/assets/scss/**/*.scss"
const SCSS_DES = "./src/assets/css"

//Compile SASS SCSS
function compileSCSS(){
  console.log("Change Detected by Gulp, Compiling CSS")
  return(
      gulp
